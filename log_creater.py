...
This code should be saved on Carbon but you can connect to Carbon from your local computer to run it.

1) Run this script:
   - The log is appended to OUTPUT_FILE (LOG_TXT = "Low_cost_sensors_log_qq.txt"
...
OUTPUT_FILE = LOG_TXT = "Low_cost_sensors_log_qq.txt"
